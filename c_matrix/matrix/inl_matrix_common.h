...
#ifndef  C_INL_MATRIX_COMMON_H
#define  C_INL_MATRIX_COMMON_H
...
#define _ERROR_MATRIX_INVERSE_FAILED                            0X0000000f      //矩阵求逆失败
#define _ERROR_CREATE_VECTOR_FAILED                             0X00000010      //创建向量失败
#define _ERROR_VECTOR_DIMENSION_NOT_EQUAL                       0X00000011      //向量维数不相同
#define _ERROR_VECTOR_NORM_TYPE_INVALID                         0X00000012      //向量模类型无效
#define _ERROR_VECTOR_CROSS_FAILED                              0X00000013      //向量叉乘失败
